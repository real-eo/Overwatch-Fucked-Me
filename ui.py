...
class ui:
    ...
    def _labels_(self):
        ...
        placeholderPortrait = PhotoImage(file=f"sources/portraits/blank.png").subsample(3, 3)
        ...
        self.roleIconList = [PhotoImage(file=f"sources/icons/role/{i}Icon.png").subsample(4, 4) for i in ['tank', 'dps', 'support']]
    ...
    def tank(self):
        ...
        self.tankPortraitList = [PhotoImage(file=f"sources/portraits/tank/{self.characters[0][x]}.png").subsample(4, 4) for x, i in enumerate(self.characters[0])]
    ...
    def dps(self):
        ...
        self.dpsPortraitList = [PhotoImage(file=f"sources/portraits/dps/{self.characters[1][x]}.png").subsample(4, 4) for x, i in enumerate(self.characters[1])]
    ...
    def support(self):
        ...
        self.supportPortraitList = [PhotoImage(file=f"sources/portraits/support/{self.characters[2][x]}.png").subsample(4, 4) for x, i in enumerate(self.characters[2])]
